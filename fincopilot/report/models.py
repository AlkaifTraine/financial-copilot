...
class ReportModel:
    ...
    # Publication status set by run_qa: "PASSED" when no CRITICAL finding remains,
    # "FAILED" (with blocked=True) otherwise. qa_findings carries every finding as
    # {severity, check, message}, most severe first.
